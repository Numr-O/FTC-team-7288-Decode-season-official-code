...
public class Indexer_testing extends OpMode {
...
//        robotHardware.turretMotor.setPower(1);
        ...
        telemetry.addData("Current Velocity: ", robotHardware.shooterMotorBottom.getVelocity(AngleUnit.DEGREES));
...
//        }
        ...
        telemetry.addData("Turret motor Power: ", robotHardware.turretMotor.getCurrent(CurrentUnit.AMPS));
