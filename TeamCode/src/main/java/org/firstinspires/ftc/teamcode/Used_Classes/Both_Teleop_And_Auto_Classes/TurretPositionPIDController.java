...
public class TurretPositionPIDController {
    ...
    public double updatePosition(double currentMotorPosition,double xPos, double yPos, double currentAngleError, double currentTXError, double initialDistance) {
        ...
        return pidfController.calculate(currentMotorPosition,desiredMotorPosition);
    }
